...
import ANNModels.KalmanRNNnet as KalmanRNNnet
    ...
    for i in range(num_trial):
        ...
        if i < 1:
            fig, (ax1, ax2) = plt.subplots(
                2, 1, sharey=True, sharex=True, figsize=(5, 5)
            )
        ...
        activity_dict.append(
            rnn_activity[env.start_ind["delay"] : env.end_ind["delay"]]
        )
...
def main():
    ...
    #RNNモデルの作成
    net = create_KalmanRNN(env)

    for noise_Amplitude in [0.2]:
        num_trial = 200
